...
MONGODB_PWD="Ke0SEpfrBBZ57z44KKfIMZfnYjjJVZEuD4T"    #Add your MongoDB admin password from your my-passwords.yml file in the ubuntu home folder.

S3_BUCKET="preescolar.atentamente.mx/backups"  #For this script to work you'll first need the following:
